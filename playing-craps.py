# this is Ben Robin's playing-craps file 

# playing craps file 2 Ben Robin
...
print ('Craps %',craps/iterations)
print ('Win %', win/iterations)

#Cleaning up Results formating 
print('Craps Percent',int(craps/iterations*100),'%')
print('Win Percent',int(win/iterations*100),'%')
